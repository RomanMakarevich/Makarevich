...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/product-factory-app/user/{userId}/*").hasRole(USER.name())
                .antMatchers(HttpMethod.PUT, "/product-factory-app/products/{productId}").hasRole(EMPLOYEE.name())
                .antMatchers(HttpMethod.GET, "/product-factory-app/orders").hasAnyRole(EMPLOYEE.name())
                .antMatchers(HttpMethod.POST, "/product-factory-app/orders/{orderId}").hasAnyRole(EMPLOYEE.name())
